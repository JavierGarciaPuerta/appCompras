...
export class FacturasService {
  ...
  appComprasCore = 'http://localhost:8080/factura';
  ...
  getFacturas() {
    return this.http.get(this.appComprasCore)
      .map(res => res.json());
  }

  delteFactura(idFactura: any){
    return this.http.delete(this.appComprasCore + idFactura)
      .map(res => res.json());
  }
